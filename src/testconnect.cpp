...
constexpr char TOKEN[] = "22o1nfbfv24b9x1oq4ie";
...
// Attribute names
constexpr const char LED_STATE_ATTR[] = "sharedvalueFan";
constexpr const char LED_BRIGHTNESS_ATTR[] = "sharedvalueLight";
...
void processSharedAttributes(const JsonObjectConst &data)
{
    ...
    for (auto it = data.begin(); it != data.end(); ++it)
    {
        ...
        if (strcmp(key, "sharedvalueFan") == 0 && it->value().is<bool>())
        {
            ...
            Serial.printf("Updated fan state: %d\n", fanState ? 1 : 0);
        }
        ...
        Serial.printf("Updated light state: %d\n", lightState ? 1 : 0);
    }
}
